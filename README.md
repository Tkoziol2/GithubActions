[![Run App TateKoziol](https://github.com/Tkoziol2/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Tkoziol2/GithubActions/actions/workflows/run-app.yaml)
